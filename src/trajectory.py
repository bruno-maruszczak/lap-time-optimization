...
from velocity2 import VelocityProfile2
...
class Trajectory:
    ...
    def __init__(self, track: 'Track', vehicle):
    ...
    def update_velocity(self):
        ...
        if self.vehicle.name == "our_car":
            self.velocity = VelocityProfile2(self.vehicle, s, k, s_max)
        else:
